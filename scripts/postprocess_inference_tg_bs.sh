...
INPUT_DIR="./outputs/seed=42/tg_scores_bs"
OUTPUT_DIR="./outputs/seed=42/tg_scores_bs.word"
...
METRICS_OUTPUT_DIR="./outputs/seed=42/tg_scores_bs.word"
...
FINAL_OUTPUT="./outputs/seed=42/tg_bs.csv"
