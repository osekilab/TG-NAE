...
def get_config(debug=False):
  ...
  return dm_collections.ConfigDict(
      dict(
          sentencepiece_vocab_filename="./data/bllip-lg/spm/spm.vocab",
          training=dict(
              ...
              dataset=dict(
                  ...
                  kwargs=dict(
                      filename="./data/bllip-lg/train.terminals.csv",
                      num_samples=None,
                      add_bos=True,
          ...
          evaluation=dict(
              ...
              dataset=dict(
                  name="PreEncodedTextDataset",
                  kwargs=dict(
                      filename="./data/bllip-lg/valid.terminals.csv",
                      num_samples=None,
                      add_bos=True,
                      add_eos=False,  # Not needed for Choe-Charniak.
                  ),
          ...
          seed=42,
          save_path="./experiments/txl/seed=42/checkpoint_txl.pkl",
      )
  )
